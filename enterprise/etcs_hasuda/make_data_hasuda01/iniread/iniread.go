...
type ConfigList struct {
    ...
    Large_parking_offset int     // 大型車駐車車両数オフセット（メインモニタプラスマイナスボタン用）
    Other_parking_offset int     // 大型車以外車両数オフセット（メインモニタプラスマイナスボタン用）
}
...
func LoadConfig() {
    ...
    Config = ConfigList{
        ...
        Large_parking_offset: cfg.Section("num").Key("large_parking_offset").MustInt(),      // 大型車駐車車両数オフセット（メインモニタプラスマイナスボタン用）
        Other_parking_offset: cfg.Section("num").Key("other_parking_offset").MustInt(),      // 大型車駐車車両数オフセット（メインモニタプラスマイナスボタン用）
    }
}
