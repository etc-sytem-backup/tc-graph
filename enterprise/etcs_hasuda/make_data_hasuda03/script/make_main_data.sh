...
# 引数の数を確認
if [ "$#" -ne 6 ]; then
    echo "Usage: $0 large_in_parking_cnt other_in_parking_cnt large_parking_space other_parking_space large_drivepath_cnt other_drivepath_cnt"
    exit 1
fi
...
# CSVファイルを作成
echo "${large_in_parking_cnt},${large_parking_space},${large_drivepath_cnt},${other_in_parking_cnt},${other_parking_space},${other_drivepath_cnt}" > ./disp_data/disp_main.csv
